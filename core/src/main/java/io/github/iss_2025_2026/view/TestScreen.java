...
public class TestScreen implements Screen {
    ...
    private static final String MAP_PATH = "map/generated/countryside_long.tmx";
    ...
    private void buildUI() {
        ...
        // Place the player near the beginning of the countryside road.
        if (model.getPlayerOne() != null && model.getPlayerOne().getX() == 0) {
            float[] spawn = tileToWorld(8, mapHeight / 2);
