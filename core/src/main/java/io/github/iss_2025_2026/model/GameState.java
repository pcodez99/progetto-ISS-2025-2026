...
public class GameState {
    ...
    public String getSpecialAbilityId() { return specialAbilityId; }
    public void setSpecialAbilityId(String specialAbilityId) { this.specialAbilityId = specialAbilityId; }
}
